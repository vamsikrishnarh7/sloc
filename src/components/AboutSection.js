...
let AboutSection = () => {
    return (
        ...
        <section className="about-section">
            ...
            <h1 className="about-section-motto">Help each other,<br/> Grow together</h1>
            <p className="about-section-subtext">
                This is a community which provides <span className="span-text">free hands-on training</span>
